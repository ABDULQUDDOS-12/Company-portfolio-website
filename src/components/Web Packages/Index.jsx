    ...
    <div id="web-packages" className={styles.mainContainer}>
      ...
      <div data-aos="zoom-in-up" className={styles.dropdownMenu}>
        <select name="" id="" onChange={handleOptionChange}>
          ...
          <option value="Startup Website Package">
            Startup Website Package
          </option>
          <option value="Professional Website Package">
            Professional Website Package
          </option>
          <option value="Elite Website Package">Elite Website Package</option>
          <option value="Buisness Website Package">
            Buisness Website Package
          </option>
          <option value="Corporate Website Package">
